...
function EZPZBanking_ATMUI.ATMWindow:onSubmitPIN()
    ...
    local isOwner = EZPZBanking_Utils.isCardOwner(player, card)
    local isFakeCard = string.sub(modData.accountID, 1, 5) == "FAKE_"
    local skipHacking = isFakeCard and EZPZBanking_Utils.isNoHackingMinigameEnabled()
